...
/**
 * Calcula Juros Simples Semestral de forma completamente dinâmica.
 * A fórmula deduzida da análise dos dados é:
 * 
 * PERCENTUAL APLICADO = TAXA ANUAL × PERÍODOS SEMESTRAIS × 3
 * VALOR DOS JUROS = VALOR CORRIGIDO × (PERCENTUAL APLICADO / 100)
 * 
 * onde PERÍODOS SEMESTRAIS = MESES / 6
 */
function calcularJurosSimples($valor, $taxaAnual, $dias, $diasBase = 30)
{
    // Cálculo de meses e períodos semestrais
    $meses = $dias / $diasBase;
    $periodosSemestrais = $meses / 6;

    // Cálculo do percentual aplicado
    $percentualAplicado = $taxaAnual * $periodosSemestrais * 3;

    // Cálculo do juros usando o percentual aplicado
    $juros = $valor * ($percentualAplicado / 100);
    $total = $valor + $juros;
    ...
    return [
        ...
        'dias' => $dias,
        'dias_base' => $diasBase,
        'periodos_semestrais' => $periodosSemestrais
    ];
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Calcula os juros simples semestrais
...
<head>
    <meta charset="UTF-8">
    <title>Juros Simples Semestral</title>
...
<body class="bg-light p-4">
    <div class="container bg-white p-4 rounded shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">JUROS SIMPLES SEMESTRAL</h4>
            <a href="index.php" class="btn btn-outline-secondary btn-sm">Voltar</a>
        </div>

        <p class="text-muted">
            Calcule juros simples semestrais com a fórmula:<br>
            <!-- <strong>
                PERCENTUAL APLICADO = TAXA ANUAL × PERÍODOS SEMESTRAIS × 3<br>
                VALOR DOS JUROS = VALOR CORRIGIDO × (PERCENTUAL APLICADO / 100)
            </strong><br>
            Onde PERÍODOS SEMESTRAIS = MESES / 6 e MESES = DIAS / DIAS_BASE -->
        </p>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="tipo_juros" class="form-select" disabled>
                        <option selected>Juros Simples Semestral</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
        ...
        <?php if ($resultado): ?>
            <div class="mt-4">
                ...
                <p class="bg-yellow"><strong>PERCENTUAL JUROS:</strong> <?= number_format($resultado['percentual_aplicado'], 7, ',', '') ?></p>
